...
public class EmployeeDetailsVORowImpl extends OAViewRowImpl {
    ...
    public static final int SHOWHIDE = 14;
    public static final int CREDITCARD = 15;
    public static final int EMPLOYEEASSIGNMENTSVO = 16;
    ...
    protected Object getAttrInvokeAccessor(int index, 
        ...
        case EMPLOYEEASSIGNMENTSVO:
            return getEmployeeAssignmentsVO();
        default:
    ...
    /**Gets the associated <code>RowIterator</code> using master-detail link EmployeeAssignmentsVO
     */
    public RowIterator getEmployeeAssignmentsVO() {
        return (RowIterator)getAttributeInternal(EMPLOYEEASSIGNMENTSVO);
    }
