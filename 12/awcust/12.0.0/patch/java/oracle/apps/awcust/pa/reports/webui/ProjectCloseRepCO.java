 /*===========================================================================+
  ...
  |  HISTORY                                                                  |
  +===========================================================================*/
 package oracle.apps.awcust.pa.reports.webui;
  ...
  * Controller for ...
  */
 public class ProjectCloseRepCO extends OAControllerImpl
 {
   ...
   public void processRequest(OAPageContext pageContext, OAWebBean webBean)
   {
     super.processRequest(pageContext, webBean);
       ...
       pageContext.writeDiagnostics(this,"Parameter - strProjectId: " + strProjectId,3);
       //
       ...
       pageContext.putParameter("p_DataSourceCode","XX_PA_PROJECT_CLOSE");
       pageContext.putParameter("p_DataSourceAppsShortName","AWCUST");
       pageContext.putParameter("p_TemplateCode","XX_PA_PROJECT_CLOSE");
