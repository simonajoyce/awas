...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "APPS"."XXAWAS_DEBTOR_AGEING_V" ("BOOK", "CUSTOMER_NAME", "CUSTOMER_NUMBER", "TYPE", "PAYMENT_SCHED_ID", "CLASS", "DUE_DATE", "AMT_DUE_REMAINING", "AMT_DUE_ORIGINAL", "IN_DISPUTE", "DISPUTE_AMT", "DAYS_PAST_DUE", "Future", "1-30 Days", "1-7 Days", "8-15 Days", "8-30 Days", "16-30 Days", "31-60 Days", "60+ Days", "ENTITY", "MSN", "GL_ACCOUNT", "TRX_TYPE", "CUSTOMER_PROFILE", "XRM_LEASE_NUM") AS 
  SELECT BOOK,
 ...
 SELECT distinct DECODE(ps.org_Id,2,'AWAS',44,'PAFCO',85,'AWAS','UNKNOWN') BOOK,
    ...
    DECODE('X', 'DISPUTE_ONLY',DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0),0,0,1), 'PENDADJ_ONLY',DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0),0,0,1), 'DISPUTE_PENDADJ',DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0), 0,DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0),0,0,1), 1), DECODE( GREATEST(                -999999999, CEIL(SYSDATE-PS.DUE_DATE)), LEAST(0, CEIL(SYSDATE-PS.DUE_DATE)),1, 0) * DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0), 0, 1, DECODE('X', 'DISPUTE_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1)) * DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0), 0, 1, DECODE('X', 'PENDADJ_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1)))*PS.ACCTD_AMOUNT_DUE_REMAINING bucket0,

    DECODE('X', 'DISPUTE_ONLY',DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0),0,0,1), 'PENDADJ_ONLY',DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0),0,0,1), 'DISPUTE_PENDADJ',DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0), 0,DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0),0,0,1), 1), DECODE( GREATEST(1, CEIL(SYSDATE -PS.DUE_DATE)), LEAST(30, CEIL(SYSDATE-PS.DUE_DATE)),1, 0) * DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0), 0, 1, DECODE('X', 'DISPUTE_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1)) * DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0), 0, 1, DECODE('X', 'PENDADJ_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1)))*PS.ACCTD_AMOUNT_DUE_REMAINING BUCKET1 ,

    DECODE('X', 'DISPUTE_ONLY',DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0),0,0,1), 'PENDADJ_ONLY',DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0),0,0,1), 'DISPUTE_PENDADJ',DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0), 0,DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0),0,0,1), 1), DECODE( GREATEST(1, CEIL(SYSDATE -PS.DUE_DATE)), LEAST(7, CEIL(SYSDATE-PS.DUE_DATE)),1, 0) * DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0), 0, 1, DECODE('X', 'DISPUTE_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1)) * DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0), 0, 1, DECODE('X', 'PENDADJ_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1)))*PS.ACCTD_AMOUNT_DUE_REMAINING BUCKET2 ,

    DECODE('X', 'DISPUTE_ONLY',DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0),0,0,1), 'PENDADJ_ONLY',DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0),0,0,1), 'DISPUTE_PENDADJ',DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0), 0,DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0),0,0,1), 1), DECODE( GREATEST(8, CEIL(SYSDATE -PS.DUE_DATE)), LEAST(15, CEIL(SYSDATE-PS.DUE_DATE)),1, 0) * DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0), 0, 1, DECODE('X', 'DISPUTE_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1)) * DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0), 0, 1, DECODE('X', 'PENDADJ_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1)))*PS.ACCTD_AMOUNT_DUE_REMAINING BUCKET3 ,

    DECODE('X', 'DISPUTE_ONLY',DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0),0,0,1), 'PENDADJ_ONLY',DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0),0,0,1), 'DISPUTE_PENDADJ',DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0), 0,DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0),0,0,1), 1), DECODE( GREATEST(8, CEIL(SYSDATE -PS.DUE_DATE)), LEAST(30, CEIL(SYSDATE-PS.DUE_DATE)),1, 0) * DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0), 0, 1, DECODE('X', 'DISPUTE_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1)) * DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0), 0, 1, DECODE('X', 'PENDADJ_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1)))*PS.ACCTD_AMOUNT_DUE_REMAINING BuCKET4 ,

    DECODE('X', 'DISPUTE_ONLY',DECODE(NVL(ps.amount_in_dispute,0),0,0,1), 'PENDADJ_ONLY',DECODE(NVL(ps.amount_adjusted_pending,0),0,0,1), 'DISPUTE_PENDADJ',DECODE(NVL(ps.amount_in_dispute,0), 0,DECODE(NVL(ps.amount_adjusted_pending,0),0,0,1), 1), DECODE( GREATEST(16, CEIL(SYSDATE-ps.due_date)), LEAST(30, CEIL(SYSDATE-ps.due_date)),1, 0) * DECODE(NVL(ps.amount_in_dispute,0), 0, 1, DECODE('X', 'DISPUTE_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1)) * DECODE(NVL(ps.amount_adjusted_pending,0), 0, 1, DECODE('X', 'PENDADJ_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1)))*ps.acctd_amount_due_remaining bucket5 ,

    DECODE('X', 'DISPUTE_ONLY',DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0),0,0,1), 'PENDADJ_ONLY',DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0),0,0,1), 'DISPUTE_PENDADJ',DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0), 0,DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0),0,0,1), 1), DECODE( GREATEST(31, CEIL(SYSDATE-PS.DUE_DATE)), LEAST(60, CEIL(SYSDATE-PS.DUE_DATE)),1, 0) * DECODE(NVL(PS.AMOUNT_IN_DISPUTE,0), 0, 1, DECODE('X', 'DISPUTE_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1)) * DECODE(NVL(PS.AMOUNT_ADJUSTED_PENDING,0), 0, 1, DECODE('X', 'PENDADJ_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1))) *PS.ACCTD_AMOUNT_DUE_REMAINING BUCKET6,

    DECODE('X', 'DISPUTE_ONLY',DECODE(NVL(ps.amount_in_dispute,0),0,0,1), 'PENDADJ_ONLY',DECODE(NVL(ps.amount_adjusted_pending,0),0,0,1), 'DISPUTE_PENDADJ',DECODE(NVL(ps.amount_in_dispute,0), 0,DECODE(NVL(ps.amount_adjusted_pending,0),0,0,1), 1), DECODE( GREATEST(61, CEIL(SYSDATE-ps.due_date)), LEAST(999999999999999999, CEIL(SYSDATE-ps.due_date)),1, 0) * DECODE(NVL(ps.amount_in_dispute,0), 0, 1, DECODE('X', 'DISPUTE_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1)) * DECODE(NVL(ps.amount_adjusted_pending,0), 0, 1, DECODE('X', 'PENDADJ_ONLY', 0, 'DISPUTE_PENDADJ', 0, 1))) *ps.acctd_amount_due_remaining bucket7,
