...
// ---------------------------------------------------------------------
public class ProjectCloseRepAMImpl extends OAApplicationModuleImpl {
    /**This is the default constructor (do not remove)
     */
    public ProjectCloseRepAMImpl() {
    }
    ...
    public static void main(String[] args) {
      ...
      "ProjectCloseRepAMLocal" /* Configuration Name */);
    }
    ...
    try
    {
    DataTemplate datatemplate = new DataTemplate(((OADBTransactionImpl)getOADBTransaction()).getAppsContext(), "AWCUST", "XX_PA_PROJECT_CLOSE");
