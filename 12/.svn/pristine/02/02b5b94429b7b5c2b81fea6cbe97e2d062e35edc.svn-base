...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Trigger XXUMX_ROLE_END_DATE
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "APPS"."XXUMX_ROLE_END_DATE" BEFORE 
UPDATE of end_date
ON  applsys.wf_user_role_assignments 
FOR EACH ROW
...
/
ALTER TRIGGER "APPS"."XXUMX_ROLE_END_DATE" ENABLE;
