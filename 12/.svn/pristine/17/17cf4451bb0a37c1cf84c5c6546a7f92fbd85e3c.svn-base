CREATE OR REPLACE PACKAGE XX_WT_STMT_INTERFACE_PKG
IS
  ...
  PROCEDURE    XX_WT_bank_stmt_load( x_error_message  OUT   VARCHAR2
...
PROCEDURE	interface_XX_WT_bank_stmt_std( x_error_message OUT VARCHAR2
 				           , x_error_code    OUT NUMBER
                                              );
 ...
 -- Procedure to load bank balances only
  ...
  PROCEDURE 	bank_balance_load (     errbuf        	OUT    VARCHAR2
   ...
   PROCEDURE    XX_WT_bank_bal_load( x_error_message  OUT   VARCHAR2
 				 , x_error_code	    OUT   NUMBER
 				 , p_input_file     IN    VARCHAR2
 				 , p_dir_path       IN    VARCHAR2
 				 );
...
PROCEDURE	interface_XX_WT_bank_bal( x_error_message OUT VARCHAR2
 				           , x_error_code    OUT NUMBER
                                              );
...
--+==========================================================================+
-- Change by SJOYCE 23-Jun-2014 ref Help Change 234
