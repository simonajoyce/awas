...
public class EmpAssignmentsCreateVORowImpl extends OAViewRowImpl {
    ...
    public static final int PORTAL = 41;
    ...
    /**Gets the attribute value for the calculated attribute Portal
     */
    public String getPortal() {
        return (String) getAttributeInternal(PORTAL);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute Portal
     */
