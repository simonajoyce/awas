 ...
 * Controller for ...
 */
public class awcustPersonMainCO extends OAControllerImpl
{
...
//Here we prepare the HashMap object, that cotains name of the parameter and the value of the parameters 
      ...
      phm.put("awcustParamPersonId",paramPersonId );
      phm.put("awcustParamActionOnPerson",actionInMainPersonScreen);

      pageContext.setForwardURL(
      "OA.jsp?page=/oracle/apps/awcust/awcustperson/webui/awcustManagePersonPG"
