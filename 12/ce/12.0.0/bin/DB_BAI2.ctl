...
(rec_no		RECNUM,
 ...
 column1  	NULLIF column1 =BLANKS "CASE WHEN substr(:column1,1,4) in ('CREF','RREF','TIME','CTRL','ORG3','ORG6','PBK1','PBK2','OGB1','OGB2','INS1','INS2','INS3','PBK3') then null else :column1 end",
